...
public class CandidateDetailsAndStatusTracker {
    ...
    private List<InterviewTracker> interviews = new ArrayList<>();
    ...
    public List<InterviewTracker> getInterviews() {
        return interviews;
    }

    public void setInterviews(List<InterviewTracker> interviews) {
